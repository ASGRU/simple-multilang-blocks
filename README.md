...
Push a semantic-version tag such as `v1.2.2`. The included GitHub Actions workflow packages `simple-multilang-blocks.zip`, including the GPL license, and creates a public GitHub Release. WordPress discovers it on the usual plugin-update schedule.
